...
class BatteryIndicatorSettings : public SettingsGroup
{
   ...
   public:
    ...
    DEFINE_SETTINGFACT(threshold3)              // Third threshold for battery level
    ...
    Q_INVOKABLE void setThreshold3(int value);  // Set threshold3 with validation

   private:
    void validateThreshold1();
    void validateThreshold2();
    void validateThreshold3();
    void _threshold1Changed();
    void _threshold2Changed();
    void _threshold3Changed();
};
