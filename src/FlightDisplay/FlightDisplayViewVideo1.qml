...
Item {
    ...
    property bool   _showGrid:          QGroundControl.settingsManager.videoSettings.gridLines1.rawValue
    ...
    property int    _fitMode:           QGroundControl.settingsManager.videoSettings.videoFit1.rawValue
    ...
    property double _thermalHeightFactor: 0.85 //-- TODO
        ...
        Image {
            ...
            QGCLabel {
                id:                 noVideoLabel
                text:               QGroundControl.settingsManager.videoSettings.streamEnabled1.rawValue ? qsTr("WAITING FOR VIDEO") : qsTr("VIDEO DISABLED")
                font.bold:          true
                color:              "white"
    ...
    Rectangle {
        ...
        Loader {
            ...
            property bool videoDisabled: QGroundControl.settingsManager.videoSettings.videoSource1.rawValue === QGroundControl.settingsManager.videoSettings.disabledVideoSource
        }
