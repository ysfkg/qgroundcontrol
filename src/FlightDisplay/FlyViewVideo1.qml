...
Item {
    ...
    PipState {
        ...
        onWindowAboutToOpen: {
            QGroundControl.videoManager.stopVideo1()
    ...
    Loader {
        id:             cameraLoader
        anchors.fill:   parent
        visible:        QGroundControl.videoManager.isUvc1
        source:         QGroundControl.videoManager.uvcEnabled1 ? "qrc:/qml/FlightDisplayViewUVC.qml" : "qrc:/qml/FlightDisplayViewDummy.qml"
    }

    QGCLabel {
        text: qsTr("Double-click to exit full screen")
        font.pointSize: ScreenTools.largeFontPointSize
        visible: QGroundControl.videoManager.fullScreen1 && flyViewVideoMouseArea.containsMouse
